...
@Component({
  ...
  templateUrl: './listMesure.component.html',
  styleUrls: ['./listMesure.component.scss'],
  animations: [
...
export class ListMesureComponent implements OnInit {
  ...
  columnDefs = [
    ...
    { columnDef: 'organisme', headName: 'القطاع الوزاري/المؤسسة' },
    { columnDef: 'responsables', headName: '' },
