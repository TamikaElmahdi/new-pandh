    ...
    public static class SeedingData
    {
        ...
        public static ModelBuilder Organismes(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Organisme>().HasData(new Organisme[]{
                ...
                new Organisme {Id = 16, Type = 3, Label = "هيئة المناصفة ومكافحة جميع أشكال التمييز"},
                ...
                new Organisme {Id = 21, Type = 3, Label = "الهيئة الوطنية للنزاهة والوقاية  من الرشوة ومحاربتها"},
                ...
                new Organisme {Id = 25, Type = 2, Label = "الهيئة المركزية للوقاية من الرشوة"},
        ...
        public static ModelBuilder Mesuresl(this ModelBuilder modelBuilder)
        {
            var id = 1;
            var list = new[]
            {
