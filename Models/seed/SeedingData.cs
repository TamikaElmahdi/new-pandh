    ...
    public static class SeedingData
    {
        ...
        public static ModelBuilder Organismes(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Organisme>().HasData(new Organisme[]{
                ...
                new Organisme {Id = 51, Type = 1, Label = "وزارة السياحة والنقل الجوي والصناعة التقليدية والاقتصاد الاجتماعي"},
                new Organisme {Id = 52, Type = 1, Label = "كتابة الدولة لدى وزير الطاقة والمعادن والتنمية المستدامة المكلفة بالتنمية المستدامة"},
                new Organisme {Id = 53, Type = 1, Label = "وزارة الفلاحة والصيد البحري والتنمية القروية والمياه والغابات"},

                new Organisme {Id = 54, Type = 1, Label = "وزارة الطاقة والمعادن والتنمية المستدامة"},
                new Organisme {Id = 55, Type = 1, Label = "الاتحاد العام لمقاولات المغرب"},
                new Organisme {Id = 56, Type = 1, Label = "وزارة الشؤون الخارجية والتعاون الدولي"},
                new Organisme {Id = 57, Type = 1, Label = "الوزارة المنتدبة لدى وزير الشؤون الخارجية والتعاون الدولي المكلفة بالمغاربة المقيمين بالخارج وشؤون الهجرة"},
                new Organisme {Id = 58, Type = 1, Label = "الوكالة الوطنية لمحاربة الأمية"},
                new Organisme {Id = 59, Type = 1, Label = "الأمانة العامة للحكومة"},
    ...
    return modelBuilder;
        ...
        public static ModelBuilder Indicateurs(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Indicateur>().HasData(new List<Indicateur>() {
                ...
                new Indicateur {Id = 5, Nom = "تنصيب رئيس وأعضاءالهيئة" , Source = "غير معروف"},
                ...
                new Indicateur {Id = 27, Nom = "عدد الاتفاقياتالمفعلة", Source = "غير معروف"},
                ...
                new Indicateur {Id = 99, Nom = "نسبةالتأطيرالصحي للسكانحسبالمناطقوالجهات والتخصصات            " , Source = "غير معروف"},
                new Indicateur {Id = 100, Nom = "نسبة مصالح المستعجلات الاستشفائية المؤهلة" , Source = "غير معروف"},
                new Indicateur {Id = 101, Nom = "نسبةانخفاض وفياتالأطفال", Source = "غير معروف"},
                new Indicateur {Id = 102, Nom = "نسبة انخفاضوفياتالأمهاتأثناءالولادة" , Source = "غير معروف"},
                new Indicateur {Id = 103, Nom = "عدد بنيات الاستقبال المؤهلة" , Source = "غير معروف"},
                new Indicateur {Id = 104, Nom = "انخفاض نسبةالأشخاصالمتعايشينمعالفيروسالذينيتعرضونللتمييزوالوصم", Source = "غير معروف"},
                ...
                new Indicateur {Id = 159, Nom = " عددالبحوثالعلميةالمنجزة" , Source = "غير معروف"},
                ...
                new Indicateur {Id = 220, Nom = "نسبةتنفيذالمخطط" , Source = "غير معروف"},
                ...
                new Indicateur {Id = 231, Nom = "عدد الفضاءاتالمؤهلة " , Source = "غير معروف"},
                ...
                new Indicateur {Id = 234, Nom = "المصادقة على الإطار الاستراتيجيالوطني", Source = "غير معروف"},
                ...
                new Indicateur {Id = 264, Nom = "عدد الاجتهادات القضائية المنشورة " , Source = "غير معروف"},
        ...
        public static ModelBuilder IndicateurMesures(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<IndicateurMesure>().HasData(new IndicateurMesure[]{
                ...
                new IndicateurMesure {IdMesure = 13, IdIndicateur = 16},
                ...
                new IndicateurMesure {IdMesure = 20, IdIndicateur = 22},
                new IndicateurMesure {IdMesure = 21, IdIndicateur = 23},
                new IndicateurMesure {IdMesure = 22, IdIndicateur = 24},
                ...
                new IndicateurMesure {IdMesure = 28, IdIndicateur = 28},
                new IndicateurMesure {IdMesure = 29, IdIndicateur = 4},
                new IndicateurMesure {IdMesure = 30, IdIndicateur = 29},
                ...
                new IndicateurMesure {IdMesure = 35, IdIndicateur = 32},
                ...
                new IndicateurMesure {IdMesure = 44, IdIndicateur = 42},
                ...
                new IndicateurMesure {IdMesure = 55, IdIndicateur = 30},
                new IndicateurMesure {IdMesure = 55, IdIndicateur = 51},
                new IndicateurMesure {IdMesure = 56,  IdIndicateur= 9},
                new IndicateurMesure {IdMesure = 57,  IdIndicateur= 25},
                new IndicateurMesure {IdMesure = 58,  IdIndicateur= 52},
                new IndicateurMesure {IdMesure = 59,  IdIndicateur= 53},
                new IndicateurMesure {IdMesure = 60,  IdIndicateur= 53},
                new IndicateurMesure {IdMesure = 61,  IdIndicateur= 53},
                ...
                new IndicateurMesure {IdMesure = 68,  IdIndicateur= 60},
                new IndicateurMesure {IdMesure = 69,  IdIndicateur= 25},
                ...
                new IndicateurMesure {IdMesure = 81,  IdIndicateur= 42},
                new IndicateurMesure {IdMesure = 82,  IdIndicateur= 32},
                new IndicateurMesure {IdMesure = 82,  IdIndicateur= 9},
                ...
                new IndicateurMesure {IdMesure = 87,  IdIndicateur= 25},
                new IndicateurMesure {IdMesure = 88,  IdIndicateur= 73},
                new IndicateurMesure {IdMesure = 89,  IdIndicateur= 74},
                ...
                new IndicateurMesure {IdMesure = 102,  IdIndicateur= 9},
                ...
                new IndicateurMesure {IdMesure = 114,  IdIndicateur= 9},
